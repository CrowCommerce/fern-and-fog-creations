      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-bark">
          {/*
            ...
            Implementation plan:
            1. Add Shopify GraphQL query for shop.shippingPolicy in lib/shopify/queries/
            ...
            Reference: https://shopify.dev/docs/api/storefront/latest/queries/shop#field-shop-shippingpolicy
          */}
          ...
          <div className="mt-12 p-6 bg-mist/50 rounded-lg border border-mist">
            <p className="text-sm text-bark/70">
              <strong>Current Status:</strong> This shipping policy is static content. To update it, edit this file
